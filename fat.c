...
//************* external variables *************
static unsigned long firstDataSector, rootCluster, totalClusters;
static unsigned int  bytesPerSector, sectorPerCluster, reservedSectorCount;
static long unusedSectors, appendFileSector, appendFileLocation, fileSize, appendStartCluster;

//global flag to keep track of free cluster count updating in FSinfo sector
static unsigned char freeClusterCountUpdated;

// misc stuff
static unsigned long startBlock, totalBlocks;
static unsigned char buffer[512];

static unsigned int dateFAT, timeFAT;

#define TX_NEWLINE
#define SD_readSingleBlock(a) 0
#define SD_writeSingleBlock(b) 0
#define transmitString_F(c)
#define transmitString(c)
#define transmitByte(c)
#define receiveByte() 0
#define getDateTime_FAT() 0
